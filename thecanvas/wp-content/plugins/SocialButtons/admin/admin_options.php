...
?>
	...
	<input type="text" name="facebookUrl" id="facebookUrl" value="<?php echo $existingFb; ?>" /><br>
	<label for="facebook">Enter the link to your Twitter account</label>
	<input type="text" name="twitterUrl" id="twitterUrl" value="<?php echo $existingTw; ?>" /><br>
	<label for="facebook">Enter the link to your Instagram account</label>
	<input type="text" name="instagramUrl" id="instagramUrl" value="<?php echo $existingInst; ?>" /><br>
	<label for="facebook">Enter the link to your YouTube account</label>
	<input type="text" name="youtubeUrl" id="youtubeUrl" value="<?php echo $existingYt; ?>" /><br><br>
